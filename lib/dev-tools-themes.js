...
var bw = require('remote').BrowserWindow;
var rootPath = '';
...
module.exports = {
  ...
  config: {
    ...
    "display-help": {
      ...
      "description":  "[Untick me when you have manually enabled 'Allow custom UI themes'](https://github.com/travs/dev-tools-themes/blob/master/assets/ui-instructions.md)",
      "type":         "boolean",
      "default":      "true"
    }
  },
  ...
  changeTheme: function (theme) {
    ...
    if (atom.config.get('dev-tools-themes.display-help')) {
      atom.notifications
        .addWarning('dev-tools-themes: Be sure you have [enabled custom UI.](https://github.com/travs/dev-tools-themes/blob/master/assets/ui-instructions.md)',
          {
